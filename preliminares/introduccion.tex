...
En conjunto, estos objetivos combinan la modelización matemática de la decisión estratégica con los principios de la ingeniería del \textit{software} y el diseño de videojuegos, dando lugar a un prototipo jugable fundamentado teóricamente y técnicamente sólido.
...
El \textbf{Capítulo~\ref{estado_del_arte}} presenta el estado del arte en diseño de videojuegos. Se revisan los géneros que inspiran el proyecto, los referentes mecánicos y narrativos, así como los principales modelos de agentes deliberativos empleados en entornos interactivos.
...
El \textbf{Capítulo~\ref{cap_software}} describe la implementación técnica del prototipo en Unreal Engine, con especial atención a la arquitectura del \textit{software}, el sistema de cartas y el comportamiento del agente rival. 
