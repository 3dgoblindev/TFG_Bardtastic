...
\usepackage{placeins} % opcional: \FloatBarrier
...
\input{capitulos/capitulo-definiciones}
\input{capitulos/capitulo-equilibrio}
\input{capitulos/capitulo-ejemplos}
\input{capitulos/capitulo-algoritmos}
\input{capitulos/capitulo-nuestro_caso}
\input{capitulos/capitulo-estado_del_arte}
\input{capitulos/capitulo-planificacion}
\input{capitulos/capitulo-herramientas}
\input{capitulos/capitulo-software}
\input{capitulos/capitulo-evaluacion}
\input{capitulos/capitulo-conclusiones}
