...
\chapter{Ejemplos de juegos}\label{cap3}
...
El siguiente ejemplo está tomado textualmente de \cite[ejemplo 2.2]{TeoriaDeJuegosCJP}.
...
En este contexto, la información sobre la calidad del coche no es completa ni simétrica: los vendedores conocen más que los compradores. Por tanto, el juego presenta información incompleta.
