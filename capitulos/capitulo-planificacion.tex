...
\begin{itemize}
  ...
  \item \textbf{Decisión desacoplada}: la IA rival se modela como una \emph{estrategia} independiente del agente jugador, con utilidades auxiliares para evaluar jugadas.
