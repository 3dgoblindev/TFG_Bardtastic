...
\begin{itemize}
    ...
    \item \textbf{Posibilidad futura de publicar en consolas} sin rehacer el \textit{pipeline} técnico ni migrar el proyecto.
...
Es importante destacar que todo el arte desarrollado para el prototipo (modelos, texturas, animaciones, iconografía y materiales) es de elaboración propia, producido específicamente para este prototipo.
