...
\begin{itemize}
    \item \textbf{Notion}: organización del desarrollo, diseño del juego y documentación.
    \item \textbf{Git}: control de versiones del código y activos con configuración específica para repositorios de Unreal.
\end{itemize}
